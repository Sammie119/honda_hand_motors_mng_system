...
<div class="d-flex justify-content-between align-items-center p-2 my-3 text-white bg-secondary rounded shadow-sm">
    ...
    <button class="btn btn-outline-dark btn-sm float-right create" value="new_transaction" data-bs-target="#getlargeModal" data-bs-toggle="modal" title="New Transaction">New Transaction</button>
</div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <a href="print_invoice/{{ $transaction->transaction_id }}" class="btn btn-info btn-sm print" title="Print Invoice">Print</a>
                                {{-- <button class="btn btn-success btn-sm edit" value="{{ $transaction->transaction_id }}" data-bs-target="#getlargeModal" data-bs-toggle="modal" title="Edit Details">Edit</button> --}}
                                <button class="btn btn-danger btn-sm delete" value="{{ $transaction->invoice_no }}" data-bs-toggle="modal" data-bs-target="#comfirm-delete" role="button">Del</button>
                            </div>
                        </td>
                    </tr>
                @empty
    ...
    <script>
        ...
        // Table filter
            ...
            $(document).on('click', '.edit', function(){
                $('.modal-title').text('Edit Transaction Details');

                var editModal=$(this).val();
                $.get('edit-modal/edit_transaction/'+editModal, function(result) {
            ...
            $(document).on('click', '.delete', function(){
                ...
                var id=$(this).val();
                $.get('delete-modal/delete_transaction/'+id, function(result) {
